...
async function getWeather(){
    ...
    const cityInput = document.getElementById('search-weather').value
    ...
    precipitationContainer.innerHTML =` <p id="precipitation">Precipitation: </p><p id="precipitation">${Math.round(precipitation)}</p>`
    ...
    switch(weatherCode) {
      case 0:
        ...
        break;
      case  1,2:
        console.log('Mainly clear, partly cloudy')
        weatherSymbol = '<img id="Lager_2" src="/media/icons/PNG/partlyCloudy.png" alt="partly cloudy"/> '
        break;
      case 3:
      ...
      case 45,48:
        console.log('Fog')
        weatherSymbol = ' <img id="Lager_2" src="/media/icons/PNG/fog.png" alt="fog"/>'
        break;
      case 51, 61, 80:
